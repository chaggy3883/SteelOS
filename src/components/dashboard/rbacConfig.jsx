...
export const WIDGET_LIBRARY = [
  ...
  { id: 'bid_pricing_hold', name: 'Bid Follow-Up Due', category: 'estimator', icon: AlertTriangle, minW: WIDGET_MIN_W, minH: WIDGET_MIN_H, defaultW: 2, defaultH: 2, description: 'Submitted bids approaching or past their 21-day follow-up window with no decision logged', route: '/estimating' },
...
export const BUILTIN_ROLES = [
  ...
  { name: 'estimator', label: 'Estimator', is_system: true, description: 'Estimating, BID Worksheet, CRM', allowed_modules: ['/', '/employee-center', '/quality/kpi-builder','/estimating', '/estimating/analytics', '/estimating/spec-review', '/projects', '/crm', '/intelligence', '/intelligence-signals', '/documents', '/rfis', '/submittals', '/portal/login'], allowed_widgets: ['bid_list', 'active_bids_count', 'bid_win_rate', 'bid_pricing_hold', 'bid_history', 'quick_add_bid'] },
  { name: 'project_manager', label: 'Project Manager', is_system: true, description: 'Job Tracking, Change Orders, Logistics, Billing', allowed_modules: ['/', '/employee-center', '/quality/kpi-builder','/projects', '/production', '/shipping', '/field-operations', '/field-operations/rigging-inspection', '/field-operations/equipment-service', '/accounting', '/documents', '/rfis', '/submittals', '/reports', '/payroll/hours', '/intelligence-signals', '/meeting-mode', '/portal/login'], allowed_widgets: ['active_projects', 'change_orders', 'fab_progress', 'shipments_calendar', 'invoiced_vs_remaining', 'project_health_summary', 'change_order_pipeline', 'shipments_calendar_widget', 'pending_requisition_approvals_widget', 'material_received_tracker_widget'] },
  ...
  { name: 'controller', label: 'Controller', is_system: true, description: 'Month-end close, budgeting, cash management, and cost accounting oversight', allowed_modules: ['/', '/employee-center', '/quality/kpi-builder', '/accounting', '/payroll/hours', '/payroll/setup', '/payroll/processing', '/certified-payroll', '/reports', '/executive-analytics', '/intelligence-signals', '/meeting-mode'], allowed_widgets: ['invoiced_vs_remaining', 'buyout_variance_widget', 'pending_requisition_approvals_widget'] },
