...
export const BUILTIN_ROLES = [
  ...
  { name: 'payroll_admin', label: 'Payroll Admin', is_system: true, description: 'Payroll and personnel compensation records', allowed_modules: ['/', '/employee-center','/accounting', '/human-resources', '/payroll', '/portal/login'], allowed_widgets: [] },
