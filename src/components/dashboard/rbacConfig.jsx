...
export const BUILTIN_ROLES = [
  ...
  { name: 'project_manager', label: 'Project Manager', is_system: true, description: 'Job Tracking, Change Orders, Logistics, Billing', allowed_modules: ['/', '/employee-center','/projects', '/production', '/shipping', '/field-operations', '/field-operations/rigging-inspection', '/accounting', '/documents', '/rfis', '/reports', '/payroll/hours', '/portal/login'], allowed_widgets: ['active_projects', 'change_orders', 'fab_progress', 'shipments_calendar', 'invoiced_vs_remaining', 'project_health_summary', 'change_order_pipeline', 'shipments_calendar_widget', 'pending_requisition_approvals_widget', 'material_received_tracker_widget'] },
  ...
  { name: 'shop_manager', label: 'Shop Manager', is_system: true, description: 'Production & quality oversight', allowed_modules: ['/', '/employee-center','/production', '/quality', '/safety', '/inventory', '/shop-operations', '/shop-floor-command-center', '/field-operations', '/field-operations/rigging-inspection', '/payroll/hours'], allowed_widgets: ['fab_progress'] },
  ...
  { name: 'controller', label: 'Controller', is_system: true, description: 'Month-end close, budgeting, cash management, and cost accounting oversight', allowed_modules: ['/', '/employee-center', '/accounting', '/human-resources', '/payroll', '/payroll/hours', '/certified-payroll', '/reports', '/executive-analytics'], allowed_widgets: ['invoiced_vs_remaining', 'buyout_variance_widget', 'pending_requisition_approvals_widget'] },
  ...
  { name: 'Maintenance_Manager', label: 'Maintenance Manager', is_system: true, description: 'Exclusive write access to the Field Operations fleet, repair, and rigging ledgers', allowed_modules: ['/', '/employee-center', '/field-operations', '/field-operations/rigging-inspection'], allowed_widgets: [] },
];
