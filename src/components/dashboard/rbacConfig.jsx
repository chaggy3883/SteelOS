...
export const BUILTIN_ROLES = [
  ...
  { name: 'project_manager', label: 'Project Manager', is_system: true, description: 'Job Tracking, Change Orders, Logistics, Billing', allowed_modules: ['/', '/employee-center','/projects', '/production', '/shipping', '/field-operations', '/accounting', '/documents', '/rfis', '/reports', '/payroll/hours', '/portal/login'], allowed_widgets: ['active_projects', 'change_orders', 'fab_progress', 'shipments_calendar', 'invoiced_vs_remaining', 'project_health_summary', 'change_order_pipeline', 'shipments_calendar_widget', 'pending_requisition_approvals_widget', 'material_received_tracker_widget'] },
  ...
  { name: 'shop_manager', label: 'Shop Manager', is_system: true, description: 'Production & quality oversight', allowed_modules: ['/', '/employee-center','/production', '/quality', '/safety', '/inventory', '/shop-operations', '/shop-floor-command-center', '/field-operations', '/payroll/hours'], allowed_widgets: ['fab_progress'] },
