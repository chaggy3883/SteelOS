...
export const BUILTIN_ROLES = [
  ...
  { name: 'project_manager', label: 'Project Manager', is_system: true, description: 'Job Tracking, Change Orders, Logistics, Billing', allowed_modules: ['/', '/employee-center','/projects', '/production', '/shipping', '/field-operations', '/field-operations/rigging-inspection', '/field-operations/equipment-service', '/accounting', '/documents', '/rfis', '/reports', '/payroll/hours', '/intelligence-signals', '/portal/login'], allowed_widgets: ['active_projects', 'change_orders', 'fab_progress', 'shipments_calendar', 'invoiced_vs_remaining', 'project_health_summary', 'change_order_pipeline', 'shipments_calendar_widget', 'pending_requisition_approvals_widget', 'material_received_tracker_widget'] },
  ...
  { name: 'president', label: 'President', is_system: true, description: 'Executive visibility', allowed_modules: ['/', '/employee-center','/estimating', '/estimating/analytics', '/estimating/spec-review', '/projects', '/crm', '/accounting', '/reports', '/executive-analytics', '/admin', '/legal', '/intelligence-signals', '/portal/login'], allowed_widgets: ['bid_list', 'active_bids_count', 'bid_history', 'active_projects', 'invoiced_vs_remaining', 'pending_requisition_approvals_widget'] },
  ...
  { name: 'finance_department', label: 'Finance Department', is_system: true, description: 'Financial review access', allowed_modules: ['/', '/employee-center','/accounting', '/estimating', '/estimating/analytics', '/estimating/spec-review', '/reports', '/executive-analytics', '/intelligence-signals', '/portal/login'], allowed_widgets: ['bid_list', 'active_bids_count', 'bid_history', 'invoiced_vs_remaining'] },
  { name: 'controller', label: 'Controller', is_system: true, description: 'Month-end close, budgeting, cash management, and cost accounting oversight', allowed_modules: ['/', '/employee-center', '/accounting', '/human-resources', '/payroll', '/payroll/hours', '/certified-payroll', '/reports', '/executive-analytics', '/intelligence-signals'], allowed_widgets: ['invoiced_vs_remaining', 'buyout_variance_widget', 'pending_requisition_approvals_widget'] },
  ...
  { name: 'Maintenance_Manager', label: 'Maintenance Manager', is_system: true, description: 'Exclusive write access to the Field Operations fleet, repair, and rigging ledgers', allowed_modules: ['/', '/employee-center', '/field-operations', '/field-operations/rigging-inspection', '/field-operations/equipment-service'], allowed_widgets: [] },
];
