...
export const BUILTIN_ROLES = [
  ...
  { name: 'controller', label: 'Controller', is_system: true, description: 'Month-end close, budgeting, cash management, and cost accounting oversight', allowed_modules: ['/', '/employee-center', '/accounting', '/payroll', '/payroll/hours', '/payroll/setup', '/payroll/processing', '/certified-payroll', '/reports', '/executive-analytics', '/intelligence-signals', '/meeting-mode'], allowed_widgets: ['invoiced_vs_remaining', 'buyout_variance_widget', 'pending_requisition_approvals_widget'] },
