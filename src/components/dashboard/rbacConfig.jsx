...
export const BUILTIN_ROLES = [
  ...
  { name: 'payroll_admin', label: 'Payroll Admin', is_system: true, description: 'Payroll and personnel compensation records', allowed_modules: ['/', '/employee-center','/accounting', '/human-resources', '/payroll', '/payroll/hours', '/payroll/setup', '/certified-payroll', '/portal/login'], allowed_widgets: ['interviews_calendar'] },
  ...
  { name: 'controller', label: 'Controller', is_system: true, description: 'Month-end close, budgeting, cash management, and cost accounting oversight', allowed_modules: ['/', '/employee-center', '/accounting', '/human-resources', '/payroll', '/payroll/hours', '/payroll/setup', '/certified-payroll', '/reports', '/executive-analytics', '/intelligence-signals', '/meeting-mode'], allowed_widgets: ['invoiced_vs_remaining', 'buyout_variance_widget', 'pending_requisition_approvals_widget'] },
